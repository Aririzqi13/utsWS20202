...
echo "<p class='sidebar-title'> $record[judul]</p>
    <small class='date'><span class='glyphicon glyphicon-time'></span> $record[hari], $tanggal, $record[jam] WIB, $record[dibaca] View<a href='".base_url()."berita/json_version'>Lihat JSON Version</a><a href='".base_url()."berita/loadxml'>Export</a><a href='".base_url()."berita/json_encode'>Encode_json</a></small>
